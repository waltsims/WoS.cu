...
Each SM contains execution units for 32-bit integer, as well as single and double
precision arithmetic. Special function units for log/exp sin/cos and sqrt functions.

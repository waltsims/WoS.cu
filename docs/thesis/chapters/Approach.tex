...
The mathematical use-case implemented for this proof of concept is the special case of \ref{eq:poisson}.
\begin{equation}
  \begin{aligned}
...
We find the suitable boundary function $g$ to transform \ref{eq:poisson} into \ref{eq:laplace}
with a boundary value of
 ...
 \end{aligned}
   \end{equation}
The goal is to efficiently numerically solve \ref{eq:poc} point-wise in $\Omega$.

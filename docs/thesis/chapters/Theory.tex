...
thereby increasing the applicability of this solving algorithm\cite{?}. \Glspl{RWoS} is highly parallel, %discribe how eliptic pds can be transformed.
...
namely a =(0,0).
%TODO: discuss the rotational independence as can be seen by the independenc of

...
of the random motions of particles.  This motion is used in order to iteratively traverse a series %Markov Chain
of spheres in a domain $\Omega$ on which a harmonic PDE is defined in order to % dictated by Brownian Motion ...

...
\end{figure}
 ...
 The solution of a harmonic \gls{PDE} given the boundary
...
explicit call to synchronization functions called via the \incpp{__syncthreads()}
...
\begin{description}
  ...
  Global memory is allocated dynamically by the user via \incpp{cudaMalloc()} and \incpp{cudaFree()} functions.
